...
document.addEventListener('DOMContentLoaded', function() {
    ...
    shareProjectBtn.addEventListener('click', function() {
        ...
        if (!user || !user.loggedIn) {
            showMessage('Please sign in to share your project', 'info');
            setTimeout(() => {
    ...
    projectPhotos.addEventListener('change', function(e) {
    ...
    shareForm.addEventListener('submit', function(e) {
        ...
        const formData = {
            ...
            photos: photoPreviewGrid.children.length
        };

        console.log('Sharing project:', formData);
        
        // Simulate successful submission
        showMessage('Project shared successfully!', 'success');
        closeModal();
        
        // In a real app, would add the project to the grid
        setTimeout(() => {
            showMessage('Your project is now visible to the community', 'info');
        }, 1500);
    });
